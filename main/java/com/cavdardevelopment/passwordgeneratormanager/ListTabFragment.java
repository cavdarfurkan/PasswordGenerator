package com.cavdardevelopment.passwordgeneratormanager;
...
public class ListTabFragment extends Fragment {
    ...
    private void init(View view){
        ...
        // AD REQUEST
        AdView adViewListFragmentBanner = view.findViewById(R.id.adViewListFragmentBanner);
        AdRequest adRequest2 = new AdRequest.Builder().build();
        adViewListFragmentBanner.loadAd(adRequest2);

//        Button buttonDebug = view.findViewById(R.id.buttonDebug);
//        final SQLiteDBHelper ddbb = new SQLiteDBHelper(getContext());
//        buttonDebug.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                ddbb.clearDB();
//                deleteAllSavedPasswordList();
//            }
//        });
    }
